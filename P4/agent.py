...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        self.trial = 0           # Number of trials. To be used in the exploration function
    ...
    def build_state(self):
        ...
        state = (waypoint, inputs.get('left'), inputs.get('right'), inputs.get('oncoming'), inputs.get('light'))
        return state
